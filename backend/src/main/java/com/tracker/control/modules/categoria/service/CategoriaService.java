package com.tracker.control.modules.categoria.service;
...
import com.tracker.control.modules.categoria.repository.CategoriaRepository;
...
public class CategoriaService {
    ...
    private CategoriaDTO toDTO(Categoria c) {
        return new CategoriaDTO(c.getId(), c.getNome(), c.getTipo(), c.getIcone(), c.getCor());
    }
}
