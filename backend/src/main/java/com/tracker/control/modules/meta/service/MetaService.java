package com.tracker.control.modules.meta.service;
...
import com.tracker.control.modules.meta.repository.MetaRepository;
...
public class MetaService {
    ...
    private MetaDTO toDTO(Meta m) {
        return new MetaDTO(m.getId(), m.getTitulo(), m.getDescricao(), m.getValorAlvo(),
                m.getValorAtual(), m.getDataLimite(), m.getConcluida());
    }
}
