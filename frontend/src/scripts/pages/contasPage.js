                ...
                <tbody>
                    ${contas.map(c => `
                        <tr>
                            ...
                            <td style="font-weight:600;color:${c.saldo >= 0 ? "var(--success)" : "var(--danger)"}">
                                ${formatarMoeda(c.saldo)}
                            </td>

                            <td>
                                <button class="btn btn-outline btn-editar-conta" data-id="${c.id}" data-nome="${c.nome}" data-tipo="${c.tipo}" data-saldo="${c.saldo}" style="margin-right:0.5rem">
                                    <i class="pi pi-pencil"></i>
                                </button>

                                <button class="btn btn-danger btn-excluir-conta" data-id="${c.id}">
