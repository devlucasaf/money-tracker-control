                    ...
                    ${orcamentos.map(o => {
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <small>
                                    ${formatarMoeda(gasto)} (${percentual.toFixed(0)}%)
                                </small>
                            </td>

                            <td style="font-weight:600;color:${disponivel >= 0 ? "var(--success)" : "var(--danger)"}">
                            ...
                            <td>
                                <button class="btn btn-danger btn-excluir-orcamento" data-id="${o.id}">
