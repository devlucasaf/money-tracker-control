            ...
            <table>
                ...
                <tbody>
                    ${categorias.map(c => `
                        <tr>
                            <td>
                                <span class="color-dot" style="background:${c.cor ?? "#6366f1"}"></span>
                            </td>
                            ...
                            <td>
                                <span class="badge ${c.tipo === "RECEITA" ? "badge-success" : "badge-danger"}">${c.tipo}</span>
                            </td>
                            
                            <td>
                                <button class="btn btn-outline btn-editar-categoria" data-id="${c.id}" data-nome="${c.nome}" data-tipo="${c.tipo}" data-cor="${c.cor ?? "#6366f1"}" style="margin-right:0.5rem">
                                    <i class="pi pi-pencil"></i>
                                </button>

                                <button class="btn btn-danger btn-excluir-categoria" data-id="${c.id}">
